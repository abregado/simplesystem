 ...
 * @extends {ActorSheet}
 */
export class SimplesystemActorSheet extends ActorSheet {
  ...
  /** @override */
  get template() {
    return `systems/simplesystem/templates/actor/actor-${this.actor.type}-sheet.html`;
  }
  ...
  _onRoll(event) {
    ...
    // Handle item rolls.
    if (dataset.rollType) {
      if (dataset.rollType.includes('item')) {
